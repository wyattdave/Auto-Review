...
function load() {
  ...
  const oReport=JSON.parse(LZString.decompress(localStorage.getItem('report')));
console.log(oReport);
  ...
  const a=nomnoml.renderSvg(oReport.diagram);
  document.getElementById('content-diagram').innerHTML=a;
  const svgElm=document.getElementsByTagName('svg')[0];
  svgElm.setAttribute('width', '100%');
  svgElm.setAttribute('height','100%');
  let sWidth=svgElm.getAttribute('width');
  let iStartWidth=parseInt(sWidth.substring(0,sWidth.length-1));
...
function downloadHTML(){
  ...
  sHTML=sHTML.replaceAll('src="vendor/','src="https://wyattdave.github.io/Auto-Review/appreview/assets/');
  sHTML=sHTML.replaceAll('href="vendor/','href="https://wyattdave.github.io/Auto-Review/appreview/assets/');
  sHTML=sHTML.replaceAll('href="css/','href="https://wyattdave.github.io/Auto-Review/appreview/assets/css/');
  sHTML=sHTML.replaceAll('src="js/','src="https://wyattdave.github.io/Auto-Review/appreview/assets/js/');
  sHTML=sHTML.replaceAll('src="img/appreview.svg','src="https://wyattdave.github.io/Auto-Review/appreview/assets/img/appreview.svg');
